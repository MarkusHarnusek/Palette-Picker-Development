    ...
    public partial class MainWindow : Window
    {
        ...
        private void Btn_Save_Click(object sender, RoutedEventArgs e)
        {
            PublicProfile publicProfile = new PublicProfile
            {
                ...
                Name = currentEditingName == "" ? "Default" : currentEditingName,
                Description = "Generated by PalettePicker",
                Author = Config.username ?? "Unknown",
                IsPublic = true,
                Created = DateTime.Now,
                Modified = DateTime.Now,
                IsDark = Config.isDarkMode,
                BaseColor = Primary1 ?? "#FFFFFF",
                Views = 0,
                Favorites = 0,
                Downloads = 0,
                Colors = new Dictionary<string, string>
                {
                    { "p1", Primary1 ?? "#FFFFFF" },
                    { "p2", Primary2 ?? "#FFFFFF" },
                    { "s1", Secondary1 ?? "#FFFFFF" },
                    { "s2", Secondary2 ?? "#FFFFFF" },
                    { "text", Text ?? "#000000" }
                }
            };
